...
namespace ScriptKidAntiCheat
{
    public partial class FakeCheatForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((!Program.GameData.MatchInfo.IsMatchmaking && !Program.GameData.MatchInfo.IsFaceit) && !Program.Debug.AllowLocal)
                {
                    ...
                    MessageBox.Show("You need to join a matchmaking or faceit game before injecting.", "No match in progress", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                }
            }
            else
            {
