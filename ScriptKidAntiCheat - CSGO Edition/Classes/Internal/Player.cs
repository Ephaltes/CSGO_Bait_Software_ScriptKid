...
namespace ScriptKidAntiCheat.Internal
{
    public class Player : EntityBase
    {
        ...
        public float getFlashDuration(GameProcess gameProcess)
        {
            float FlashDurationValue = gameProcess.Process.Read<float>(AddressBase + Offsets.m_flFlashDuration);
        ...
        public override bool Update(GameProcess gameProcess)
        {
            ...
            FlashDuration = getFlashDuration(gameProcess);
